  ...
  return (
    ...
    >
      <div className="header z-10 bg-transparent rounded-md p-6 font-thin">
        ...
        <h2 className="color--titles rounded-md p-2 max-w-xl mx-auto text-4xl mt-1 font-semibold  text-center">Nosotros si, <span className="font-bold">resolvemos!</span></h2>
        <h3 className="color--titles rounded-md font-light p-2 max-w-3xl text-3xl mt-2 text-center">
